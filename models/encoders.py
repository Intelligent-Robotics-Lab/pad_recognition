...
class TextTransformerEncoder(nn.Module):
    ...
    """
    def __init__(self, hidden_dim=768, d_model=512, nhead=4, num_layers=2, dropout=0.2):
        super().__init__()
    ...
    def forward(self, token_embeddings):
        ...
        # Experiment 2: Add encoder output normalization
...
class AudioProjectionEncoder(nn.Module):
    def __init__(self, input_dim=42, d_model=512, use_gru=False):
        super().__init__()
